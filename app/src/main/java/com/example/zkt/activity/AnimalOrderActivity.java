...
public class AnimalOrderActivity extends AppCompatActivity {
    ...
    private String[] titles = new String[]{"全部","认养中","配送中","已完成"};//托管类型
    ...
    private void initViewPager() {
        ...
        pageFragment.add(AnimalOrderFragment.newInstance(titles[0],this,1));

        for (int i = 1; i < titles.length; i++) {
            pageFragment.add(AnimalOrderFragment.newInstance(titles[i],this,i));
        }
