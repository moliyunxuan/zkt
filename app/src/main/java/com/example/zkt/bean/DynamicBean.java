...
public class DynamicBean implements Serializable {
    ...
    public DynamicBean(int id, String dt, int type, String content, SenderBean sender, List<CommentsBean> comments, List<ImageBean> images, List<PraiseBean> praiseList) {
        this.id = id;
        this.dt = dt;
        this.type = type;
        this.content = content;
